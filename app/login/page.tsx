...
export default function LoginPage() {
  return (
    <div style={{ minHeight: "100vh", display: "flex", alignItems: "center", justifyContent: "center", padding: 24 }}>
      <div className="pg-card" style={{ width: "100%", maxWidth: 400, textAlign: "center" }}>
        <div className="pg-card-accent"></div>
        <div style={{ display: "flex", flexDirection: "column", alignItems: "center", gap: 16, marginBottom: 32 }}>
          <PentagonIcon />
          <div>
            <h1 style={{ fontFamily: "'Cinzel Decorative', serif", fontSize: 20, fontWeight: 700, color: "#e8e3d0", marginBottom: 6 }}>
              Pentagono <span style={{ color: "#8b1a1a" }}>da Maldade</span>
            </h1>
            <p style={{ fontSize: 11, color: "#6b6655", fontFamily: "'Cinzel', serif", letterSpacing: "0.06em", textTransform: "uppercase" }}>
              Acesso restrito ao grupo
            </p>
          </div>
        </div>

        <div style={{ borderTop: "1px solid #1e1a0f", paddingTop: 28 }}>
          <button
            onClick={() => signIn("google", { callbackUrl: "/" })}
            className="pg-btn-ghost"
            style={{ width: "100%", padding: "12px", display: "flex", alignItems: "center", justifyContent: "center", gap: 10, fontSize: 13 }}
          >
